...
global image_base, list_folder_to_rewrite, extension_config
list_folder_to_rewrite = []
image_base = os.getcwd()
extension_config = "toml"
...
def convert_file(file, new_format, output_folder = os.getcwd()):
    ...
    write.write_above(new_file, write.generate_text(new_file, extension_config))
